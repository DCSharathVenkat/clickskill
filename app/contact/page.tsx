            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg">
                  <h3 className="font-semibold text-slate mb-2">Need Immediate Assistance?</h3>
                  <p className="text-neutral-600 text-sm mb-4">For urgent inquiries, call our 24/7 support line:</p>
                  <a href="tel:+1-555-123-4567" className="text-primary font-semibold text-lg">
                    +1 (555) 123-4567
                  </a>
                </div>
              </div>
