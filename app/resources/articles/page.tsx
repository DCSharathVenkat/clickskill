...
const articles = [
  {
    ...
    excerpt: "Learn from common pitfalls and discover best practices for successful AI adoption in large organizations.",
    ...
    href: "/resources/articles/ai-implementation-mistakes",
  },
  {
    title: "The Rise of Edge Computing: Transforming Data Processing",
    excerpt: "Explore how edge computing is revolutionizing real-time data processing and reducing latency for critical applications.",
    author: "Michael Chen",
    publishDate: "December 12, 2024",
    readTime: "8 min read",
    category: "Technology Trends",
    tags: ["Edge Computing", "Data Processing", "IoT"],
    image: "/images/edgecomp.jpg",
    href: "/resources/articles/edge-computing",
  },
  {
    title: "Building Resilient Cloud Architectures: Lessons from 2024",
    excerpt: "Key insights and architectural patterns for creating robust, scalable cloud infrastructure that can withstand disruptions.",
    ...
    href: "/resources/articles/cloud-architecture",
  },
  {
    title: "The Future of Work: How AI is Reshaping Job Roles",
    excerpt: "An analysis of how artificial intelligence is transforming traditional job functions and creating new opportunities.",
    author: "David Thompson",
    publishDate: "December 8, 2024",
    readTime: "7 min read",
    category: "Future of Work",
    tags: ["AI Impact", "Workforce", "Digital Transformation"],
    image: "/images/aireshape.jpg",
    href: "/resources/articles/future-of-work",
  },
  {
    title: "Sustainable Technology: Green Computing in Enterprise",
    excerpt: "How organizations are adopting sustainable technology practices to reduce environmental impact while maintaining performance.",
    author: "Lisa Wang",
    publishDate: "December 5, 2024",
    readTime: "9 min read",
    category: "Sustainability",
    tags: ["Green Tech", "Sustainability", "Enterprise"],
    image: "/images/greencomp.jpg",
    href: "/resources/articles/green-computing",
  },
  {
    title: "Cybersecurity Trends to Watch in 2025",
    excerpt: "Emerging cybersecurity threats and defense strategies that will shape the security landscape in the coming year.",
    author: "James Miller",
    ...
    href: "/resources/articles/cybersecurity-trends",
  },
]
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Subscribe to our newsletter and get the latest articles, insights, and technology trends delivered to your inbox weekly.
            </p>
