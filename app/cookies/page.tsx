  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden bg-white text-gray-900">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-800 mt-4 max-w-2xl mx-auto">
            Learn how ClickSkill uses cookies to enhance your browsing experience.
          </p>
        </div>
      ...
      <article className="p-8 max-w-4xl mx-auto text-gray-800">
        <p className="mb-4">
          This Cookie Policy explains how ClickSkill uses cookies to enhance your experience on our website.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">What Are Cookies?</h2>
        <p className="mb-4">
          Cookies are small data files stored on your device that help us remember your preferences and understand how you interact with our site.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Types of Cookies We Use</h2>
        <p className="mb-4">
          We use essential cookies for core functionality, performance cookies to improve our site, and marketing cookies to personalize content.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Managing Cookies</h2>
        <p className="mb-4">
          You can control cookie settings through your browser. Disabling some cookies may affect site performance and functionality.
        </p>
      </article>
    </div>
  )
